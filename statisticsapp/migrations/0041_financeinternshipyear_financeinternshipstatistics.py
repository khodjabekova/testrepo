...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('statisticsapp', '0040_alter_annualcost_options_alter_country_options_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='FinanceInternshipYear',
            fields=[
        ...
        migrations.CreateModel(
            name='FinanceInternshipStatistics',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_created_by', to=settings.AUTH_USER_MODEL)),
                ('field', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='statisticsapp.sciencefield')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_updated_by', to=settings.AUTH_USER_MODEL)),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='statisticsapp.financeinternshipyear')),
            ],
            options={
                'verbose_name': 'Ilmiy stajirovkalarni moliyalashtirish',
                'verbose_name_plural': 'Ilmiy stajirovkalarni moliyalashtirish',
